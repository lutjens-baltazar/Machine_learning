...
# cat = RLCat(game.cat_pos, "QTableCat49000.npy")        # Reemplazar con el nombre del archivo de la Q-Table
# mouse = RLMouse(game.mouse_pos, "QTableMouse40000.npy")  # Reemplazar con el nombre del archivo de la Q-Table
